...
NET "io_port<0>" LOC = P144 | IOSTANDARD = LVTTL;
NET "io_port<1>" LOC =  | IOSTANDARD = LVTTL;
NET "io_port<2>" LOC =  | IOSTANDARD = LVTTL;
NET "io_port<3>" LOC =  | IOSTANDARD = LVTTL;
NET "io_port<4>" LOC =  | IOSTANDARD = LVTTL;
NET "io_port<5>" LOC =  | IOSTANDARD = LVTTL;
NET "io_port<6>" LOC =  | IOSTANDARD = LVTTL;
NET "io_port<7>" LOC =  | IOSTANDARD = LVTTL;
NET "io_port<8>" LOC =  | IOSTANDARD = LVTTL;
NET "io_port<9>" LOC =  | IOSTANDARD = LVTTL;
NET "io_port<10>" LOC =  | IOSTANDARD = LVTTL;
NET "io_port<11>" LOC =  | IOSTANDARD = LVTTL;
NET "io_port<12>" LOC =  | IOSTANDARD = LVTTL;
NET "io_port<13>" LOC =  | IOSTANDARD = LVTTL;
NET "io_port<14>" LOC =  | IOSTANDARD = LVTTL;
NET "io_port<15>" LOC =  | IOSTANDARD = LVTTL;

NET "CYC_I" LOC =  | IOSTANDARD = LVTTL;
NET "WE_I" LOC =  | IOSTANDARD = LVTTL;
NET "STB_I" LOC =  | IOSTANDARD = LVTTL;
NET "ACK_I" LOC =  | IOSTANDARD = LVTTL;